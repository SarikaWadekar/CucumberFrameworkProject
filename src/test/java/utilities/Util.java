...
public class Util {
    ...
    public Boolean dataValidation(List<WebElement> element, String expectedText) {
        reusableDataValidation(element, expectedText);
        return flag;
    }

    public String dataValidationText(List<WebElement> element, String expectedText) {
        reusableDataValidation(element, expectedText);
        Assert.assertTrue(flag);
        return text;
    }

    public void reusableDataValidation(List<WebElement> element, String expectedText) {
        flag = false;
        int totalElementSize = element.size();
